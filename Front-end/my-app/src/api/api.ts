...
export const addCategory = async (categoryName: string,typeId:number) => {
...
export const addType = async (typeName: string) => {
  ...
  export const addAttribute = async (attributeName:string , typeId:number)=>{
    ...
    export const editAttribute = async (attributeName: string, attributeId: number) =>{
